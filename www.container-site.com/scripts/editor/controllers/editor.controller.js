(function(angular) {
  ...
  function EditorCtrl($scope, $log, $document, GarfieldService, PagesService) {
     ...
     * @param {string} strPageOwner The project id (requirejs) from which the page should be taken
     * @param {string} strPageId The id of the page which should be injected
     */
    vm.selectPage = function (page) {
      ...
      GarfieldService.inject(page.owner, page.path, page.directive, scope, '#page-editor', null, false)
    }
  }
})(angular);